...
namespace XboxDownload
{
    internal class DnsListen
    {
        ...
        public static string[,] dohs = { { "阿里云", "https://223.5.5.5/resolve", "" }, { "腾讯云", "https://1.12.12.12/resolve", "" }, { "360", "https://180.163.249.75/resolve", "" }, { "Google", "https://104.21.45.47/resolve", "dc.skydevil.xyz" }, { "DNS.SB(Globa)", "https://52.69.240.75/doh.sb/dns-query", "xbox.skydevil.xyz" }, { "DNS.SB(日本东京)", "https://52.69.240.75/jp-nrt.doh.sb/dns-query", "xbox.skydevil.xyz" }, { "DNS.SB(日本大阪)", "https://202.5.221.130/dns-query", "jp-kix.doh.sb" }, { "DNS.SB(韩国首尔)", "https://52.69.240.75/kr-sel.doh.sb/dns-query", "xbox.skydevil.xyz" }, { "DNS.SB(新加坡)", "https://52.69.240.75/sg-sin.doh.sb/dns-query", "xbox.skydevil.xyz" }, { "DNS.SB(中国香港)", "https://52.69.240.75/hk-hkg.doh.sb/dns-query", "xbox.skydevil.xyz" }, { "DNS.SB(印度班加罗尔)", "https://143.244.128.32/dns-query", "in-blr.doh.sb" }, { "DNS.SB(美国圣何塞)", "https://52.69.240.75/us-sjc.doh.sb/dns-query", "xbox.skydevil.xyz" }, { "DNS.SB(爱沙尼亚塔林)", "https://185.37.252.146/dns-query", "ee-tll.doh.sb" } };
        ...
        public void Listen()
        {
            ...
            tasks[1] = new Task(() =>
            {
                ...
                {
                    string? ip = Properties.Settings.Default.DoH ? ClassDNS.DoH("dlassets.xboxlive.cn") : ClassDNS.HostToIP("dlassets2.xboxlive.cn", Properties.Settings.Default.DnsIP);
                    if (!string.IsNullOrEmpty(ip))
                    {
